...
import com.rodrigodojo.cursomc.dto.ProdutoDTO;
import com.rodrigodojo.cursomc.services.ProdutoService;
...
public class ProdutoResource {
	...
	public ResponseEntity<Page<ProdutoDTO>> findPage(
		...
		Page<ProdutoDTO> listDto = list.map(obj -> new CategoriaDTO(obj));
